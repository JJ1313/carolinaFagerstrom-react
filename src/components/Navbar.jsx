    ...
    <>
      <nav id="navbar" className="d-flex bg-black-0 align-items-center justify-content-center px-4">
        ...
        <ul className="d-flex g-15 ms-auto pt-1">
          ...
          <li><a className="link txt-white txt-upper fw-600 fs-08 d-block" href="/">Sobre Mi</a></li>
          <li><a className="link txt-white txt-upper fw-600 fs-08 d-block" href="/news">Noticias</a></li>
          <li id="dropdown-obras" className="link txt-white txt-upper dropdown fw-600 fs-08 pb-1"><a href="/news">Obras</a>
          ...
          <li><a className="link txt-white txt-upper fw-600 fs-08 d-block" href="/news">Contacto</a></li>
        </ul >
