...
export function Contact() {
  return (
    <div id="contact" className="d-grid cols cols-md-2 mt-10">
      ...
      <form className="">
        <div className="form-container">
          ...
          <div className="input-container">
            <input type="email" id="email" aria-label="Correo" placeholder="Correo" className="txt-upper ff-terciary" />
          </div>
          <div className="input-container">
            <input type="text" id="subject" aria-label="Asunto" placeholder="Asunto" className="txt-upper ff-terciary" />
          </div>
          <div className="input-container">
            <textarea id="message" name="email" aria-label="Mensaje" placeholder="Mensaje" className="txt-upper ff-terciary" />
          </div>
        </div>
